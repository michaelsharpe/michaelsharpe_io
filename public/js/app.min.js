...
*/
function($){$.fn.flowtype=function(options){// Establish default settings/variables
// ====================================
var settings=$.extend({maximum:9999,minimum:1,maxFont:9999,minFont:1,fontRatio:35},options),// Do the magic math
// =================
changes=function(el){var $el=$(el),elw=$el.width(),width=elw>settings.maximum?settings.maximum:elw<settings.minimum?settings.minimum:elw,fontBase=width/settings.fontRatio,fontSize=fontBase>settings.maxFont?settings.maxFont:fontBase<settings.minFont?settings.minFont:fontBase;$el.css("font-size",fontSize+"px")};// Make the magic visible
// ======================
return this.each(function(){// Context for resize callback
var that=this;// Make changes upon resize
$(window).resize(function(){changes(that)}),// Set changes on load
changes(this)})}}(jQuery),$(document).ready(function(){(screen.width<768||$(window).width()<768)&&($(".social-icon").find("object").attr("width",60).attr("height",60),$(".social-icon").css("margin","0 0.5rem"));//Prepare a MediaQueryList
var phone=window.matchMedia("(max-width:768px)"),desktop=window.matchMedia("(min-width:768px");//Add a listener to the MediaQueryList
phone.addListener(function(e){e.matches&&($(".social-icon").find("object").attr("width",60).attr("height",60),$(".social-icon").css("margin","0 0.5rem"))}),desktop.addListener(function(e){e.matches&&($(".social-icon").find("object").attr("width",80).attr("height",80),$(".social-icon").css("margin","0 1rem"))}),// Make icons into links
$(".social-icons li").on("click",function(){console.log("test")})});